...
;; color scheme
(define base00 #(29 32 33))
(define base01 #(50 48 47))
(define base02 #(80 73 69))
(define base03 #(102 92 84))
(define base04 #(146 131 116))
(define base05 #(168 153 132))
(define base06 #(213 196 161))
(define base07 #(253 244 193))
(define base08 #(251 84 63))
(define base09 #(254 134 37))
(define base0A #(250 192 59))
(define base0B #(149 192 133))
(define base0C #(139 165 155))
(define base0D #(13 102 120))
(define base0E #(143 70 115))
(define base0F #(168 115 34))

(define framework:color-schemes
  `(#hash((name . "Darktooth Dark")
